...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0fekjke.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0fekjke.containers.anotherwebservice.com/
...
```
git clone git@github.com:guilb012/container-0fekjke.git
cd container-0fekjke
```
...
```
docker attach container-0fekjke
```
